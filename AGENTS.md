...
- **App Android en el mismo cambio**: si el cambio toca API de avisos, cola de portería, QR de visita, push/FCM o estados de visita, incluir `apps/android` (mismo paquete, sin bumpear `versionCode`). En cola: DNI sin pase → Identidad leída → Anunciar al lote (120 s) o Registrar visita (check-in).

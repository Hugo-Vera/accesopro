...
export const RELAY_PRESETS: {
  ...
  { label: "Puerta peatonal", match: /peaton|sótano|sotano/i, kind: "door", cam: true },
  { label: "Barrera", match: /barrera|cancela|eclusa|boom/i, kind: "gate", cam: true },
  { label: "Portón / ingreso", match: /portón|porton|ingres|entrada|\bin\b/i, kind: "gate", cam: true },
